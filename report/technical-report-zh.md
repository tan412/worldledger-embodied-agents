...
技术报告 | 公开发布候选版 0.1 | 2026 年 9 月 23 日
...
[E5] 多机器人轨迹集合。本地仓库：runs_multi_robot_480_v1/summary.json、docs/multi_robot_pipeline.md。内容包括 480 个回合的计数、任务定义、已记录的重放覆盖情况，以及 19 组同场景修正对。绝对资产路径引用仍是这一历史集合的可迁移性限制。
